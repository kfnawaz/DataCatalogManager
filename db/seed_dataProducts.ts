...
export async function seed_dataProducts() {
  ...
  try {
    ...
    await db.insert(dataProducts).values({
      ...
      description: "Comprehensive Value at Risk report, summarizing the potential loss in portfolio value due to market movements",
      owner: "Risk Analytics Team",
      domain: "Risk",
      sources: [
      ...
      tags: ["var", "risk-management", "regulatory-reporting"],
      sla: "99.9% availability",
      updateFrequency: "Daily with intraday updates",
    });
