...
export async function seed_dataProducts() {
  ...
  try {
    ...
    await db.insert(dataProducts).values({
      ...
      description: "Aggregate risk metrics at the portfolio level providing comprehensive risk analysis",
    ...
    await db.insert(dataProducts).values({
      ...
      description: "Aggregated stress test results and scenario analysis for portfolios",
      ...
      schema: {
        ...
        required: ["scenario_id", "portfolio_id", "impact_value", "calculation_date"]
      },
    ...
    await db.insert(dataProducts).values({
      ...
      description: "Aggregated market risk factors including volatility, correlations, and interest rate curves",
      ...
      schema: {
        ...
        required: ["risk_factor_id", "risk_factor_type", "time_series_date", "value"]
      },
    ...
    await db.insert(dataProducts).values({
      ...
      schema: {
        ...
        required: ["counterparty_id", "exposure_value", "credit_rating", "default_probability"]
      },
    ...
    await db.insert(dataProducts).values({
      ...
      schema: {
        ...
        required: ["metric_id", "portfolio_id", "metric_type", "value", "compliance_status"]
      },
